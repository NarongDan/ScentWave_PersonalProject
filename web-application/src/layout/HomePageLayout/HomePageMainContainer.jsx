    ...
    <div className="w-screen h-[100%] flex flex-col bg-gray-100">
      ...
      <footer className="flex flex-evenly min-h-20 bg-black text-white px-16 py-8 space-x-8">
        <div className="flex-1 space-y-4">
          ...
          <p className="text-xs">
            Discover the art of fragrance with SCENTWAVE. Our mission is to
            create captivating scents that leave a lasting impression. From
            timeless classics to contemporary creations, we blend the finest
            ingredients to bring you perfumes that evoke emotions and memories.
          </p>
        </div>
        <div className="flex-1 space-y-4">
